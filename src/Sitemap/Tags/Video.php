...
namespace Amplify\System\Sitemap\Tags;
...
class Video
{
    ...
    public function __construct(string $thumbnailLoc, string $title, string $description, ?string $contentLoc = null, string|array|null $playerLoc = null, array $options = [], array $allow = [], array $deny = [], array $tags = [])
    {
