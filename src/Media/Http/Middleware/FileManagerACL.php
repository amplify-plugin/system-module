...
namespace Amplify\System\Media\Http\Middleware;

use Amplify\System\Media\Services\ACLService\ACL;
    ...
    protected function checkPaste()
    {
        ...
        $checkDirs = Arr::first($clipboard['directories'],
            function ($value) use ($clipboard, $getLevel) {
                return $getLevel > $this->acl->getAccessLevel($clipboard['disk'], $value);
            }, null);
